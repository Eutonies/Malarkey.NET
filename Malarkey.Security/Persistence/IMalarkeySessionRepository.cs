...
{
    Task<MalarkeyAuthenticationSession> InitNewSession(MalarkeyOAuthIdentityProvider idProvider, string nonce, string? forwarder, string codeChallenge, string codeVerifier, DateTime initTime);

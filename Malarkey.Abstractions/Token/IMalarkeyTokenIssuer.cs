...
public interface IMalarkeyTokenIssuer
{
    public string PublicKey { get; }

    public IMalarkeyClientTokenIssuer ToClientTokenIssuer() => new MalarkeyClientTokenIssuerFromGeneralIssuer(PublicKey, this, ServiceScopeFactory);
